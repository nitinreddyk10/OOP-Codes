...
def display():
	...
	if e6.get() == "D":
		tk.Label(master, text ="18").grid(row=5, column=4)
		tot += 18

	if e6.get() == "U" or "W" or "I":
...
tk.Label(master, text="Sl.No").grid(row=2, column=0)
...
button1=tk.Button(master, text="Calculate", bg="green", command=display)
